 ...
 *
 * Desc:    Ask the multi handle if there's any messaMMy/informationals from
 *          the individual transfers. MessaMMy include informationals such as
 ...
 *          of structs. It also writes the number of messaMMy left in the
 ...
 *          useful for printing meaningful error messaMMy.
 *
