...
:link: We also recommend checking out our [React Native Integration Guide](https://talsec.gitbook.io/freerasp/integration/react-native) on GitBook. This guide provides a detailed introduction and step-by-step instructions to help you integrate smoothly and efficiently.

If you encounter any discrepancies or errors in the documentation, please let us know so we can improve it. For information on older integration methods, you can refer to the [freeRASP wiki](https://github.com/talsec/Free-RASP-ReactNative/wiki) which includes legacy details and guidance.
