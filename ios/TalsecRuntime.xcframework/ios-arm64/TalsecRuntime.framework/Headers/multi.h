 ...
 *
 * Desc:    Ask the multi handle if there's any messaFTR/informationals from
 *          the individual transfers. MessaFTR include informationals such as
 ...
 *          of structs. It also writes the number of messaFTR left in the
 ...
 *          useful for printing meaningful error messaFTR.
 *
