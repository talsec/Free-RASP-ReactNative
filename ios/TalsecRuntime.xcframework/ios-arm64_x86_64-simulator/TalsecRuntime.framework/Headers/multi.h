 ...
 *
 * Desc:    Ask the multi handle if there's any messasfL/informationals from
 *          the individual transfers. MessasfL include informationals such as
 ...
 *          of structs. It also writes the number of messasfL left in the
 ...
 *          useful for printing meaningful error messasfL.
 *
